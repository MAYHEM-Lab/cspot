...
if ( ! test -e "$HERE/senspot-file-recv.$TYPE" ) ; then
	curl -fsSL https://raw.githubusercontent.com/MAYHEM-Lab/cspot/release-3.0/dist/senspot-file-recv.$TYPE -o $HERE/senspot-file-recv.$TYPE
	chmod 700 $HERE/senspot-file-recv.$TYPE
fi

if ( ! test -e "$HERE/update-cspot-distribution.sh" ) ; then
	curl -fsSL https://raw.githubusercontent.com/MAYHEM-Lab/cspot/release-3.0/dist/update-cspot-distribution.sh -o $HERE/update-cspot-distribution.sh
