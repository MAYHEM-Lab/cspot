...
all: log-test log-test-thread log-dump woof-repair repair.o woofc.o woofc-host.o woofc-shepherd.o woofc-container woofc-namespace-platform docker-image woofc-forker-helper
