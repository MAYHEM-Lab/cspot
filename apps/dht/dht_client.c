...
// #ifdef USE_RAFT
//     if (element_size > RAFT_DATA_TYPE_SIZE) {
//         sprintf(dht_error_msg, "element size %lu exceeds RAFT_DATA_TYPE_SIZE %lu", element_size,
//         RAFT_DATA_TYPE_SIZE); return -1;
//     }
// #endif
...
//             break;
//         } else {
//             sprintf(dht_error_msg, "failed to put data to raft: %s", raft_error_msg);
//             return -1;
//         }
//     }
//     if (i == DHT_REPLICA_NUMBER) {
//         sprintf(dht_error_msg, "failed to map data to raft: %s", "none of replica is working leader");
//         return -1;
//     }
...
//     }
//     if (raft_is_error(mapping_index)) {
//         sprintf(dht_error_msg, "failed to map data to raft: %s", raft_error_msg);
//         return -1;
//     }
...
//            (mapped - committed),
//            (redirect2 - committed));
//     printf("h_trigger: %" PRIu64 " %" PRIu64 " %" PRIu64 "\n", triggered, (triggered - called), (triggered -
//     mapped)); fflush(stdout);
//     // #endif
