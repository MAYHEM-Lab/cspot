...
char *WOOF_TO_CREATE[] = {RAFT_LOG_ENTRIES_WOOF, RAFT_SERVER_STATE_WOOF, RAFT_HEARTBEAT_WOOF, RAFT_TIMEOUT_CHECKER_WOOF,
	RAFT_APPEND_ENTRIES_ARG_WOOF, RAFT_APPEND_ENTRIES_RESULT_WOOF, RAFT_CLIENT_PUT_ARG_WOOF, RAFT_CLIENT_PUT_RESULT_WOOF,
	RAFT_RECONFIG_ARG_WOOF, RAFT_RECONFIG_RESULT_WOOF, RAFT_REPLICATE_ENTRIES_WOOF,
...
unsigned long WOOF_ELEMENT_SIZE[] = {sizeof(RAFT_LOG_ENTRY), sizeof(RAFT_SERVER_STATE), sizeof(RAFT_HEARTBEAT), sizeof(RAFT_TIMEOUT_CHECKER_ARG),
	sizeof(RAFT_APPEND_ENTRIES_ARG), sizeof(RAFT_APPEND_ENTRIES_RESULT), sizeof(RAFT_CLIENT_PUT_ARG), sizeof(RAFT_CLIENT_PUT_RESULT),
	sizeof(RAFT_RECONFIG_ARG), sizeof(RAFT_RECONFIG_RESULT), sizeof(RAFT_REPLICATE_ENTRIES_ARG),
