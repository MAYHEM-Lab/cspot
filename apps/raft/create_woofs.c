...
char *WOOF_TO_CREATE[] = {RAFT_LOG_ENTRIES_WOOF, RAFT_SERVER_STATE_WOOF, RAFT_REQUEST_VOTE_ARG_WOOF, RAFT_REQUEST_VOTE_RESULT_WOOF, 
	...
	RAFT_REVIEW_APPEND_ENTRIES_ARG_WOOF, RAFT_TERM_ENTRIES_WOOF, RAFT_REPLICATE_ENTRIES_WOOF,
	RAFT_TERM_CHAIR_ARG_WOOF, RAFT_HEARTBEAT_ARG_WOOF};
unsigned long WOOF_ELEMENT_SIZE[] = {sizeof(RAFT_LOG_ENTRY), sizeof(RAFT_SERVER_STATE), sizeof(RAFT_REQUEST_VOTE_ARG), sizeof(RAFT_REQUEST_VOTE_RESULT),
	...
	sizeof(RAFT_REVIEW_APPEND_ENTRIES_ARG), sizeof(RAFT_TERM_ENTRY), sizeof(RAFT_REPLICATE_ENTRIES_ARG),
	sizeof(RAFT_TERM_CHAIR_ARG), sizeof(RAFT_HEARTBEAT_ARG)};
